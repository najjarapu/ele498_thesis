# Node 21 —> Node 42: A request from a malicious switch to the controller with the datapacket ID (DPID) 
# of another legitimate switch causes the legitimate switch to be disconnected from the controller. 
# A novel attack might be spoofing the legitimate switch by this method.
...
# Potential additions could be to try to close ports and all 
# sw 
